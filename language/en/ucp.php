...
$lang = array_merge($lang, array(
	...
	<br />
	Our forums are powered by Pixlz™  (hereinafter “they”, “them”, “their”, “Pixlz™  software”, “www.pixlz.in”, “Pixlz™ ”, “Pixlz™ Team”) which is a bulletin timeline solution released under the “<a href="http://opensource.org/licenses/gpl-2.0.php">GNU General Public License v2</a>” (hereinafter “GPL”) . The Pixlz™  software only facilitates internet based discussions; Pixlz™  Limited is not responsible for what we allow and/or disallow as permissible content and/or conduct. For further information about phpBB, please see: <a href="https://www.pixlz.in/">https://www.pixlz.in/</a>.<br />
	<br />
	You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-orientated or any other material that may violate any laws be it of your country, the country where “%1$s” is hosted or International Law. Doing so may lead to you being immediately and permanently banned, with notification of your Internet Service Provider if deemed required by us. The IP address of all posts are recorded to aid in enforcing these conditions. You agree that “%1$s” have the right to remove, edit, move or close any topic at any time should we see fit. As a user you agree to any information you have entered to being stored in a database. While this information will not be disclosed to any third party without your consent, neither “%1$s” nor Pixlz™ shall be held responsible for any hacking attempt that may lead to the data being compromised.
	',
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Thanks for registering to Nexus! Now login using your Nexus ID to register for the Sketch Event.',
	'ACCOUNT_COPPA'					=> 'Your account has been created but has to be approved, please check your email for details.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Your account has been updated. However, this timeline requires account reactivation on email changes. An activation key has been sent to the new email address you provided. Please check your email for further information.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Your account has been updated. However, this timeline requires account reactivation by the administrators on email changes. An email has been sent to them and you will be informed when your account has been reactivated.',
	'ACCOUNT_INACTIVE'				=> 'Your account has been created. However, this timeline requires account activation. An activation key has been sent to the email address you provided. Please check your email for further information and also be sure to check your junk mail box. It may take a while to get the email depending on your email provider.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Your account has been created. However, this timeline requires account activation by the administrator group. An email has been sent to them and you will be informed when your account has been activated.',
	...
	'ALLOW_PM'						=> 'Allow users to send you direct messages',
	...
	'ATTACHMENTS_EXPLAIN'			=> 'This is a list of attachments you have made in posts to this timeline.',
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'You can choose your profile photo from a locally available set of avatars.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Remote avatar',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Link to profile photo from another website.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Upload profile photo',
	...
	'AVATAR_FEATURES_DISABLED'		=> 'The profile photo functionality is currently disabled.',
	'AVATAR_GALLERY'				=> 'Local gallery',
	'AVATAR_GENERAL_UPLOAD_ERROR'	=> 'Could not upload profile photo to %s.',
	'AVATAR_NOT_ALLOWED'			=> 'Your profile photo cannot be displayed because profile photos have been disallowed.',
	'AVATAR_PAGE'					=> 'Page',
	'AVATAR_SELECT'					=> 'Select your profile photo',
	'AVATAR_TYPE'					=> 'profile photo type',
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Your current profile photo cannot be displayed because its type has been disallowed.',
	...
	'BOOKMARKS_DISABLED'		=> 'Bookmarks are disabled on this timeline.',
	...
	'CONFIRM_EXPLAIN'			=> 'To prevent automated registrations the timeline requires you to enter a confirmation code. The code is displayed in the image you should see below. If you are visually impaired or cannot otherwise read this code please contact the %sBoard Administrator%s.',
	...
	'DELETE_COOKIES_CONFIRM'	=> 'Are you sure you want to delete all cookies set by this timeline?',
	...
	'DELETE_MESSAGE_CONFIRM'	=> 'Are you sure you want to delete this direct message?',
	...
	'EMAIL_REMIND'				=> 'This must be the email address associated with your account. If you have not changed this via your all settings then it is the email address you registered your account with.',
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Before you may continue browsing the timeline you are required to change your password.',
	...
	'HIDE_ONLINE_EXPLAIN'		=> 'Changing this setting won’t become effective until your next visit to the timeline.',
	...
	'LOGIN_LINK'					=> 'Link or register your account on an external service with your timeline account',
	'LOGIN_LINK_EXPLAIN'			=> 'You have attempted to login with an external service that is not yet connected to an account on this timeline. You must now either link this account to an existing account or create a new account.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'No data has been provided to this page to link an external account to a forum account. Please contact the timeline administrator if you continue to experience problems.',
	'LOGIN_KEY'					=> 'Login Key',
	'LOGIN_TIME'				=> 'Login Time',
	'LOGIN_REDIRECT'			=> 'You have been successfully logged in.',
	'LOGOUT_FAILED'				=> 'You were not logged out, as the request did not match your session. Please contact the timeline administrator if you continue to experience problems.',
	...
	'NOTIFICATION_TYPE_PM'								=> 'Someone sends you a DM',
	...
	'NOTIFY_METHOD_EXPLAIN'			=> 'Method for sending messages sent via this timeline.',
	'NOTIFY_METHOD_IM'				=> 'Jabber only',
	'NOTIFY_ON_PM'					=> 'Notify me on new DM',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'You have %d direct message currently on hold because of full folder.',
		2	=> 'You have %d direct messages currently on hold because of full folder.',
	),
	...
	'NO_AUTH_DELETE_MESSAGE'		=> 'You are not authorised to delete direct messages.',
	'NO_AUTH_EDIT_MESSAGE'			=> 'You are not authorised to edit direct messages.',
	'NO_AUTH_FORWARD_MESSAGE'		=> 'You are not authorised to forward direct messages.',
	'NO_AUTH_GROUP_MESSAGE'			=> 'You are not authorised to send direct messages to groups.',
	...
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'You are not authorised to read direct messages that are on hold.',
	'NO_AUTH_READ_MESSAGE'			=> 'You are not authorised to read direct messages.',
	'NO_AUTH_READ_REMOVED_MESSAGE'	=> 'You are not able to read this message because it was removed by the author.',
	'NO_AUTH_SEND_MESSAGE'			=> 'You are not authorised to send direct messages.',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'Successfully transferred permissions from <strong>%s</strong>, you are now able to browse the timeline with this user’s permissions.<br />Please note that admin permissions were not transferred. You are able to revert to your permission set at any time.',
	'PM_DISABLED'				=> 'Private messaging has been disabled on this timeline.',
	'PM_FROM'					=> 'From',
	'PM_FROM_REMOVED_AUTHOR'	=> 'This message was sent by a user no longer registered.',
	'PM_ICON'					=> 'PM icon',
	'PM_INBOX'					=> 'Inbox',
	'PM_MARK_ALL_READ'			=> 'Mark all messages read',
	'PM_MARK_ALL_READ_SUCCESS'	=> 'All direct messages in this folder have been marked read',
	...
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Some users couldn’t be added as they do not have permission to read direct messages.',
	'PM_USERS_REMOVED_NO_PM'	=> 'Some users couldn’t be added as they have disabled direct message receipt.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'The "Remember Me" login keys automatically log you in when you visit the timeline. If you logout, the remember me login key is deleted only on the computer you are using to logout. Here you can see remember login keys created on other computers you used to access this site.',
	...
	'REPORT_PM'							=> 'Report direct message',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> '%d direct message was removed due to direct message filters.',
		2	=> '%d direct messages were removed due to direct message filters.',
	),
	...
	'SENT_AT'					=> 'Sent',			// Used before dates in direct messages
	...
	'TOO_MANY_RECIPIENTS'		=> 'You tried to send a direct message to too many recipients.',
	...
	'UCP_AUTH_LINK_ASK'			=> 'You currently have no account associated with this external service. Click the button below to link your timeline account to an account with this external service.',
	'UCP_AUTH_LINK_ID'			=> 'Unique identifier',
	'UCP_AUTH_LINK_LINK'		=> 'Link',
	'UCP_AUTH_LINK_MANAGE'		=> 'Manage external account associations',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Linking timeline accounts to external services is not supported by this timeline’s current authentication method.',
	...
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Here you can set your preferred notification methods for the timeline.',
	...
	'GROUPS_EXPLAIN'	=> 'Usergroups enable timeline admins to better administer users. By default you will be placed in a specific group, this is your default group. This group defines how you may appear to other users, for example your username colouration, avatar, rank, etc. Depending on whether the administrator allows it you may be allowed to change your default group. You may also be placed in or allowed to join other groups. Some groups may give you additional permissions to view content or increase your capabilities in other areas.',
