...
$lang = array_merge($lang, array(
	...
	'WELCOME_PHPBB'			=> 'Welcome to Pixlz Forum',
...
// Help support Pixlz™  page
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Please send information about your server and board configurations to Pixlz™  for statistical analysis. All information that could identify you or your website has been removed - the data is entirely <strong>anonymous</strong>. We base decisions about future Pixlz™  versions on this information. The statistics are made available publically. We also share this data with the PHP project, the programming language Pixlz™  is made with.',
	'EXPLAIN_SHOW_STATISTICS'	=> 'Using the button below you can preview all variables that will be transmitted.',
	'DONT_SEND_STATISTICS'		=> 'Return to the ACP if you do not wish to send statistical information to Pixlz™ .',
	...
	'FAIL_SEND_STATISTICS'		=> 'Pixlz™  was unable to send statistics',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>Converted from %1$s to Pixlz™  %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>Installed Pixlz™  %s</strong>',
	...
	'LOG_UPDATE_Pixlz™ '		=> '<strong>Updated Pixlz™  from version %1$s to version %2$s</strong>',
