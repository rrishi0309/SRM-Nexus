...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002553762d00000000395d17ca(
...
class phpbbtemplatetwiglexer_000000002553762d00000000395d17ca extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bb3766ea6bcd405843920 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bb3766ea6bd2173263065 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bb3766ea6bbc556122454 = array(
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, 'set_environment', array('env' => $env), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        return $this->valueHolder5bb3766ea6bcd405843920->set_environment($env);
    }
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        return $this->valueHolder5bb3766ea6bcd405843920->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        return $this->valueHolder5bb3766ea6bcd405843920->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 = $initializer;
    }
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__get', array('name' => $name), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        if (isset(self::$publicProperties5bb3766ea6bbc556122454[$name])) {
            return $this->valueHolder5bb3766ea6bcd405843920->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bb3766ea6bcd405843920;
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__isset', array('name' => $name), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__unset', array('name' => $name), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;
    ...
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__clone', array(), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        $this->valueHolder5bb3766ea6bcd405843920 = clone $this->valueHolder5bb3766ea6bcd405843920;
    }

    public function __sleep()
    {
        $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, '__sleep', array(), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;

        return array('valueHolder5bb3766ea6bcd405843920');
    }
    ...
    {
        return $this->initializer5bb3766ea6bd2173263065;
    }
    ...
    {
        return $this->initializer5bb3766ea6bd2173263065 && ($this->initializer5bb3766ea6bd2173263065->__invoke($valueHolder5bb3766ea6bcd405843920, $this, 'initializeProxy', array(), $this->initializer5bb3766ea6bd2173263065) || 1) && $this->valueHolder5bb3766ea6bcd405843920 = $valueHolder5bb3766ea6bcd405843920;
    }
    ...
    {
        return null !== $this->valueHolder5bb3766ea6bcd405843920;
    }
    ...
    {
        return $this->valueHolder5bb3766ea6bcd405843920;
    }
