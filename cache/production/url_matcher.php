...
class phpbb_url_matcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/ajax_base')) {
            // senky_ajaxbase_statistics
            if ('/ajax_base/statistics' === $pathinfo) {
                return array (  '_controller' => 'senky.ajaxbase.controller:handle_statistics',  '_route' => 'senky_ajaxbase_statistics',);
            }

            // senky_ajaxbase_who_is_online
            if ('/ajax_base/who_is_online' === $pathinfo) {
                return array (  '_controller' => 'senky.ajaxbase.controller:handle_who_is_online',  '_route' => 'senky_ajaxbase_who_is_online',);
            }

        }

        // tas2580_regcheck
        if ('/regcheck' === $pathinfo) {
            return array (  '_controller' => 'tas2580.regcheck.main:check',  '_route' => 'tas2580_regcheck',);
        }

        // tas2580_userinfo
        if (0 === strpos($pathinfo, '/userinfo') && preg_match('#^/userinfo/(?P<user_id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'tas2580_userinfo')), array (  '_controller' => 'tas2580.userinfo.user:info',));
        }
